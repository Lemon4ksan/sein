...
type SentPacketHandler interface {
	...
	SentPacket(
		...
		isPathMTUProbePacket, isPathProbePacket bool,
	)
	...
	ECNMode(
		isShortHeaderPacket bool,
	) protocol.ECN // isShortHeaderPacket should only be true for non-coalesced 1-RTT packets
