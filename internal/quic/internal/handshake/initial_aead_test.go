...
func TestComputeClientKeyAndIV(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedClientSecret: splitHexString(
				t,
				"14ec9d6eb9fd7af83bf5a668bc17a7e2 83766aade7ecd0891f70f9ff7f4bf47b",
			),
...
func TestComputeServerKeyAndIV(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedServerSecret: splitHexString(
				t,
				"0263db1782731bf4588e7e4d93b74639 07cb8cd8200b5da55a8bd488eafc37c1",
			),
...
func TestClientInitial(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.version.String(), func(t *testing.T) {
			...
			packet := append(slices.Clone(tt.header), sealed...)
...
func TestServersInitial(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			packet := append(slices.Clone(tc.header), sealed...)
