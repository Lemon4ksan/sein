...
func (s *SendStream) popStreamFrame(
	maxBytes protocol.ByteCount,
	v protocol.Version,
) (_ ackhandler.StreamFrame, _ *wire.StreamDataBlockedFrame, hasMoreData bool) {
	s.mutex.Lock()
...
func (s *SendStream) popNewStreamFrameForPacket(
	maxBytes protocol.ByteCount,
	v protocol.Version,
...
func (s *SendStream) popRetransmissionFrame(
	maxBytes protocol.ByteCount,
	v protocol.Version,
) (_ ackhandler.StreamFrame, hasMore bool) {
	s.mutex.Lock()
...
func (s *SendStream) Close() error {
	s.mutex.Lock()
	//nolint:nilerr // Stream is already shut down or finished writing.
