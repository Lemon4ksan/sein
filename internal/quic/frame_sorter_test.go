...
func BenchmarkFrameSorterSequential(b *testing.B) {
	data := make([]byte, 1024)
...
func BenchmarkFrameSorterSequentialBatch(b *testing.B) {
	data := make([]byte, 1024)
