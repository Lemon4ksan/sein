...
func testStreamsMapIncomingGettingStreams(
	t *testing.T,
	perspective protocol.Perspective,
	firstStream protocol.StreamID,
) {
...
func testStreamsMapIncomingDeletingStreams(
	t *testing.T,
	perspective protocol.Perspective,
	firstStream protocol.StreamID,
) {
...
func TestStreamsMapIncomingDeletingStreamsWithHighLimits(t *testing.T) {
	t.Run("client", func(t *testing.T) {
		testStreamsMapIncomingDeletingStreamsWithHighLimits(
			t,
			protocol.PerspectiveClient,
...
func testStreamsMapIncomingDeletingStreamsWithHighLimits(
	t *testing.T,
