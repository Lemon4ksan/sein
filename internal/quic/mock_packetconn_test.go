...
//
//	mockgen -typed -package quic -self_package github.com/lemon4ksan/sein/internal/quic -self_package github.com/lemon4ksan/sein/internal/quic -destination mock_packetconn_test.go net PacketConn
//
