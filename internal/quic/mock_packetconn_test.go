...
//
//	mockgen -typed -package quic -self_package github.com/lemon4ksan/aoni/x/quic -self_package github.com/lemon4ksan/aoni/x/quic -destination mock_packetconn_test.go net PacketConn
//
