...
var (
	...
	ErrControlFrameTooLarge  = errors.New("ws: control frame payload exceeds 125 octets")
	ErrFragmentedControl     = errors.New("ws: control frame must not be fragmented")
	ErrInvalidUTF8           = errors.New("ws: invalid UTF-8 payload in text frame")
	ErrPayloadTooLarge       = errors.New("ws: message payload exceeds max size")
)
